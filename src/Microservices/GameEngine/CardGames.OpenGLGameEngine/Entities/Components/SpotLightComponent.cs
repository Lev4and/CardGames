...
namespace CardGames.OpenGLGameEngine.Entities.Components
{
    public class SpotLightComponent : Component
    {
        ...
        public SpotLightComponent(Shader shader, Vector3 position, Vector3? ambient = null, Vector3? diffuse = null, 
            Vector3? specular = null, float? constant = null, float? linear = null, float? quadratic = null, 
                float? cutOff = null, float? outerCutOff = null)
        {
            _shader = shader;
            _position = position;
        ...
        public override void Draw()
        {
            ...
            var camera = EntityComponentManager.GetEntitiesWithType<CameraComponent>().FirstOrDefault()?.GetComponent<CameraComponent>() 
